...
;General
	...
	VIAddVersionKey /LANG=1033 "LegalCopyright" "Open source at https://github.com/a-popp/openvr-spacecalibrator"
...
Function .onInit
	...
	nsExec::ExecToStack 'cmd /c tasklist /FI "IMAGENAME eq vrserver.exe" 2>nul | find /I "vrserver.exe"'
	Pop $0
	Pop $1
	StrCmp $0 "0" 0 +3
